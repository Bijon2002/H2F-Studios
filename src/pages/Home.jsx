    ...
    return (
        <div className="bg-background text-on-background">
            ...
            <section id="hero" className="relative w-full h-screen flex items-end justify-center overflow-hidden">
                ...
                <div className="relative z-10 w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop pb-20 md:pb-28">
                    <div className="max-w-2xl">
                        ...
                        <div data-aos="fade-up" data-aos-delay="300" className="flex flex-wrap gap-4 items-center">
                            ...
                            <a href="tel:0720172910" className="border border-white/30 text-white font-label-caps text-label-caps py-4 px-8 hover:border-[#D4AF37] hover:text-[#D4AF37] transition-all duration-300">
                ...
                {/* Scroll indicator */}
                <button onClick={() => scrollTo('studio')} className="absolute bottom-6 left-1/2 -translate-x-1/2 z-10 text-white/40 hover:text-white transition-colors animate-bounce">
                    <ArrowDownIcon />
                </button>
            </section>
                ...
                <div className="max-w-container-max mx-auto">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14" data-aos="fade-up">
                        <div>
                            ...
                            <p className="font-body-md text-body-md text-on-surface-variant max-w-md">A curated collection of recent commissions.</p>
                        </div>
                        {/* Filters */}
                        ...
                        {filteredItems.map((item, i) => (
                            ...
                            >
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 z-10">
                                    <span className="font-label-caps text-[10px] text-[#D4AF37] tracking-[0.15em] block mb-2">{item.category}</span>
                                    <h3 className="font-display-sm text-[24px] md:text-[28px] text-white leading-tight">{item.title}</h3>
                                    <p className="font-body-md text-[14px] text-white/60 mt-1">{item.sub}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                        {motifs.map((motif, i) => (
                            <div key={motif.id} data-aos="fade-up" data-aos-delay={i * 120} className="group text-center">
                                ...
                                <h3 className="font-title-md text-title-md text-primary mb-2">{motif.title}</h3>
                                <p className="font-body-md text-[14px] text-on-surface-variant leading-relaxed">{motif.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="max-w-container-max mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-gutter">
                    ...
                    <div className="lg:col-span-5" data-aos="fade-right">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-start gap-4 group">
                                <div className="w-11 h-11 flex-shrink-0 border border-outline-variant/40 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-on-primary transition-all duration-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 -960 960 960" fill="currentColor"><path d="M480-480q33 0 56.5-23.5T560-560q0-33-23.5-56.5T480-640q-33 0-56.5 23.5T400-560q0 33 23.5 56.5T480-480Zm0 294q122-112 181-203.5T720-552q0-109-75.5-184.5T480-812q-89 0-164.5 75.5T240-552q0 71 59 162.5T480-186Zm0 106Q319-217 239.5-334.5T160-552q0-150 96.5-239T480-880q127 0 223.5 89T800-552q0 100-79.5 217.5T480-80Zm0-480Z"/></svg>
                                </div>
                                <div>
                                    <h3 className="font-label-caps text-[11px] text-on-surface-variant tracking-[0.1em] mb-1">Studio</h3>
                                    <p className="font-body-md text-body-md text-on-background">Jaffna, Sri Lanka</p>
                                </div>
                            </div>
                            {/* Phone */}
                            <div className="flex items-start gap-4 group">
                                <div className="w-11 h-11 flex-shrink-0 border border-outline-variant/40 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-on-primary transition-all duration-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 -960 960 960" fill="currentColor"><path d="M798-120q-125 0-247-54.5T329-329Q229-429 174.5-551T120-798q0-18 12-30t30-12h162q14 0 25 9.5t13 22.5l26 140q2 16-1 27t-11 19l-97 98q20 37 47.5 71.5T387-386q31 31 65 57.5t72 48.5l94-94q9-9 23.5-13.5T670-390l138 28q14 4 23 14.5t9 23.5v162q0 18-12 30t-30 12ZM241-600l66-66-17-94h-89q5 41 14 81t26 79Zm358 358q39 17 79.5 27t81.5 13v-88l-94-19-67 67ZM241-600Zm358 358Z"/></svg>
                                </div>
                                <div>
                                    <h3 className="font-label-caps text-[11px] text-on-surface-variant tracking-[0.1em] mb-1">Call for shoots</h3>
                                    <a href="tel:0720172910" className="font-body-md text-body-md text-primary font-bold hover:text-tertiary transition-colors">0720172910</a>
                                </div>
                            </div>
                            {/* Email */}
                            <div className="flex items-start gap-4 group">
                                <div className="w-11 h-11 flex-shrink-0 border border-outline-variant/40 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-on-primary transition-all duration-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 -960 960 960" fill="currentColor"><path d="M160-160q-33 0-56.5-23.5T80-240v-480q0-33 23.5-56.5T160-800h640q33 0 56.5 23.5T880-720v480q0 33-23.5 56.5T800-160H160Zm320-280L160-640v400h640v-400L480-440Zm0-80 320-200H160l320 200ZM160-640v-80 480-400Z"/></svg>
                                </div>
                                <div>
                                    <h3 className="font-label-caps text-[11px] text-on-surface-variant tracking-[0.1em] mb-1">Email</h3>
                        ...
                        <div className="mt-10 pt-8 border-t border-outline-variant/20">
                            <span className="font-label-caps text-[11px] text-on-surface-variant tracking-[0.1em] block mb-3">Follow</span>
                            <div className="flex gap-5">
                                <a className="text-on-surface-variant hover:text-primary transition-colors font-body-md text-body-md" href="#">Instagram</a>
                                <a className="text-on-surface-variant hover:text-primary transition-colors font-body-md text-body-md" href="#">Facebook</a>
                                <a className="text-on-surface-variant hover:text-primary transition-colors font-body-md text-body-md" href="#">WhatsApp</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-6 lg:col-start-7" data-aos="fade-left" data-aos-delay="150">
                        <div className="bg-surface-container-low p-8 md:p-12 border border-outline-variant/30 relative">
                            ...
                            <h3 className="font-title-md text-title-md text-primary mb-8">Booking Inquiry</h3>

                            <form action="https://formspree.io/f/placeholder" method="POST" className="space-y-7">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
                                    <div>
                                        <label className="font-label-caps text-[11px] text-on-surface-variant tracking-[0.1em] block mb-2" htmlFor="name">Name</label>
                                        <input className="w-full bg-transparent border-0 border-b border-outline-variant/40 focus:border-primary focus:ring-0 px-0 py-2 font-body-md text-body-md text-on-background transition-colors" id="name" name="name" required type="text"/>
                                    </div>
                                    <div>
                                        <label className="font-label-caps text-[11px] text-on-surface-variant tracking-[0.1em] block mb-2" htmlFor="contact">Email / Phone</label>
                                        <input className="w-full bg-transparent border-0 border-b border-outline-variant/40 focus:border-primary focus:ring-0 px-0 py-2 font-body-md text-body-md text-on-background transition-colors" id="contact" name="contact" required type="text"/>
                                    </div>
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
                                    <div>
                                        <label className="font-label-caps text-[11px] text-on-surface-variant tracking-[0.1em] block mb-2" htmlFor="event-type">Event Type</label>
                                        <select className="w-full bg-transparent border-0 border-b border-outline-variant/40 focus:border-primary focus:ring-0 px-0 py-2 font-body-md text-body-md text-on-background transition-colors appearance-none" id="event-type" name="event-type" defaultValue="">
                                    ...
                                    <div>
                                        <label className="font-label-caps text-[11px] text-on-surface-variant tracking-[0.1em] block mb-2" htmlFor="date">Date</label>
                                        <input className="w-full bg-transparent border-0 border-b border-outline-variant/40 focus:border-primary focus:ring-0 px-0 py-2 font-body-md text-body-md text-on-background transition-colors" id="date" name="date" type="date"/>
                                    </div>
                                </div>
                                <div>
                                    <label className="font-label-caps text-[11px] text-on-surface-variant tracking-[0.1em] block mb-2" htmlFor="message">Message</label>
                                    <textarea className="w-full bg-transparent border-0 border-b border-outline-variant/40 focus:border-primary focus:ring-0 px-0 py-2 font-body-md text-body-md text-on-background transition-colors resize-none" id="message" name="message" placeholder="Tell us about the significance of this moment..." required rows="4"></textarea>
                                </div>
