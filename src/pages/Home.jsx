...
<a className="font-display-sm text-display-sm tracking-tighter text-primary dark:text-primary-fixed-dim" href="#">
                H2F Studios
            </a>
<nav className="flex gap-8">
{/* Assuming 'The Studio' is conceptually closest to a Home/Overview page intent */}
...
<a className="text-on-surface-variant hover:text-primary transition-colors duration-300 font-label-caps text-label-caps hover:bg-surface-container-low/50 transition-all duration-500 ease-in-out" href="#contact">Contact</a>
</nav>
<button className="bg-primary text-on-primary font-label-caps text-label-caps px-6 py-3 rounded hover:bg-primary/90 transition-colors">
                Inquire
            </button>
</div>
</header>
{/* Mobile Nav Header (Simplified) */}
...
<a className="font-display-sm text-[24px] tracking-tighter text-primary" href="#">
            H2F
        </a>
...
<img alt="Cinematic, high-resolution hero image for a Jaffna photography portfolio. A breathtaking sunset over the Jaffna lagoon with a silhouette of palmyrah trees. Warm terracotta and gold lighting. Professional photography, sharp focus, 8k." className="w-full h-full object-cover ken-burns opacity-70" src="/images/v2/img_1.webp"/>
</div>
{/* Hero Content */}
...
<button className="mt-8 bg-transparent border border-[#D4AF37] text-[#D4AF37] font-label-caps text-label-caps px-8 py-4 rounded hover:bg-[#D4AF37]/10 transition-colors reveal delay-200 backdrop-blur-sm">
                    Explore The Studio
                </button>
</div>
{/* Scroll Indicator */}
...
{/* About Section (Parallax & Asymmetric Grid) */}
...
<p className="font-body-md text-body-md text-on-surface-variant mb-8">
                        Every frame is a testament to the tactile beauty of our culture—from the intricate patterns of pulling kolam to the timeless elegance of gold silk.
                    </p>
<a className="inline-flex items-center gap-2 text-primary font-title-md text-title-md hover:text-primary-container transition-colors group" href="#">
                        Discover our story
...
{/* Tactile tag */}
<div className="absolute -bottom-4 -left-4 bg-surface px-4 py-2 border border-outline-variant rounded-full shadow-sm">
<span className="font-label-caps text-label-caps text-tertiary">Heritage Portraiture</span>
</div>
</div>
</div>
</section>
{/* Services Overview (Bento Grid) */}
<section className="py-section-gap px-margin-mobile md:px-margin-desktop bg-surface-container-low border-t border-outline-variant/20 relative" id="portfolio">
...
{/* Card 1: Weddings (Spans 8 cols) */}
<div className="col-span-4 md:col-span-8 relative group overflow-hidden bg-surface-container cursor-pointer reveal">
<div className="absolute inset-0 bg-cover bg-center w-full h-full transition-transform duration-700 group-hover:scale-105" data-alt="A grand, traditional Jaffna Hindu wedding ceremony. The bride and groom are performing rituals around a sacred fire (Agni). Vibrant colors of silk sarees, gold jewelry glowing in the warm ambient light. High-contrast, editorial style photography capturing the emotional depth of the moment." style={{ backgroundImage: "url(\'https://lh3.googleusercontent.com/aida-public/AB6AXuD23rqxE1TEI0VX98vpSltpvzDOUFxWHSCWEgAygaDDhQqEIduy3OYNR1VrM-s-0idm7eHCMdH5t4VCxK8WOrW01fSbq5nKzdvY-qM7E5StNa_x7ZjR4iMuejtQHrFc1tu0Mab9jtsDXmldvnr_vMSoxDEOancdGvQx8eO6GbiQM-MtOYx5725-qqle64FD0EzGeJGXYGWxuJz1b1-3MjN60xN1lPmJeTvHiI1mqBLwXbk7O38FwNCx\')" }}></div>
...
<span className="material-symbols-outlined text-[#D4AF37] opacity-0 group-hover:opacity-100 transform translate-x-4 group-hover:translate-x-0 transition-all duration-300" style={{ fontVariationSettings: "'FILL' 0" }}>arrow_forward</span>
</div>
</div>
</div>
{/* Card 2: Portraits (Spans 4 cols) */}
...
<div className="absolute inset-0 bg-cover bg-center w-full h-full transition-transform duration-700 group-hover:scale-105" data-alt="Intimate, dramatic black and white studio portrait of a Jaffna elder. Heavy contrast emphasizing the texture of their skin and the wisdom in their eyes. Minimalist lighting setup, editorial fashion style approach to traditional subjects." style={{ backgroundImage: "url(\'https://lh3.googleusercontent.com/aida-public/AB6AXuDX8s2qNDd3X2JggyE-26V-9j0sGYVgcCf1zWRE_UIbAFoU9qZLkR03V3L4OKKmAXjKQaKpN0hPHxsK1wLrRec5XCm47y3aSLxsFkN_NLRoRj-1P75eD7kosaXPz8pOrx_GT5x7XgX4ykSS2gK8dPqD-twu3PHCO9egKP6W5yCC70L4bZFRkd0FZJC5TflqPqbThuXHjUStefU7nWyjJ0vcn-H2hB1Ca5HlIlldwT-SBMhm5P6pTeGh\')" }}></div>
<div className="absolute inset-0 bg-gradient-to-t from-on-background/80 via-transparent to-transparent group-hover:bg-tertiary/20 transition-colors duration-500"></div>
<div className="absolute bottom-0 left-0 p-8 w-full">
...
{/* Card 3: Commercial (Spans 5 cols) */}
<div className="col-span-4 md:col-span-5 relative group overflow-hidden bg-surface-container cursor-pointer reveal">
<div className="absolute inset-0 bg-cover bg-center w-full h-full transition-transform duration-700 group-hover:scale-105" data-alt="High-end commercial flat lay of traditional Jaffna spices and brass cookware on a dark, textured stone surface. Cinematic, moody lighting highlighting the rich reds, yellows, and metallic reflections. Sophisticated culinary photography." style={{ backgroundImage: "url(\'https://lh3.googleusercontent.com/aida-public/AB6AXuA2oc_6mIeB6RKnSdCt8meYJH0rve0WhR3j-Bhi-f5SsqhMQrmCCzA2VHQjrbBa_M2xOrnsMu6pKRXnJLPx2dH3HTVMnMyQ0Xk5vAHr7Q5wvfRDqwJmm4RyaNcqX3jCc0wpJbTErMI9uE7dwvqpjxMSiph9IksU6tWjVhFkIIUmYwgXkFlGVkenJ1o01TxSBnncDddbwxGAOu6G1-LJw4j45zi3t5bkzLUvgYTZ_bCBHFKzDD1lML5D\')" }}></div>
<div className="absolute inset-0 bg-gradient-to-t from-on-background/80 via-transparent to-transparent group-hover:bg-tertiary/20 transition-colors duration-500"></div>
<div className="absolute bottom-0 left-0 p-8 w-full">
...
<div className="absolute inset-0 bg-cover bg-center w-full h-full transition-transform duration-700 group-hover:scale-105" data-alt="A lively cultural festival in Jaffna, captured with a slow shutter speed to show the motion of traditional dancers. Brightly colored costumes blurred against a sharp, focused background of a temple gopuram. Energetic, dynamic, and colorful." style={{ backgroundImage: "url(\'https://lh3.googleusercontent.com/aida-public/AB6AXuC19hHEX5Sh-gXT0waH7Q1PXHLoIgIkPN2EcPdd4Fzmk6Wu84ET7bpUe8o8DFdktoHM9F8FDRjR4MUV9yMdEkPK9Cdcom5fmbvrG3POekXm_lIvI3oQZB5wM_uDtDp179umNPefzsxGBqhZgbqXY5rLz3yO6oqGVVJ6MbEm3zwbtdEOTzy16PLJi6fP81M_8VpduaTsQ4mCvptYCZcAEq6UiSKFmiqACMcG1akQxX5YLMBeBX227x8k\')" }}></div>
<div className="absolute inset-0 bg-gradient-to-t from-on-background/80 via-transparent to-transparent group-hover:bg-tertiary/20 transition-colors duration-500"></div>
<div className="absolute bottom-0 left-0 p-8 w-full">
<div className="flex justify-between items-end">
<div>
...
<p className="font-body-md text-body-md text-on-surface-variant max-w-xs">
                    © 2024 H2F Studios. Storytelling through the lens of Jaffna heritage.
                </p>
</div>
{/* Links */}
